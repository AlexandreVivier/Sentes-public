	...
	<section>
        ...
        <x-basicFrameContent>
            <article class="w-75">
                ...
                <p>les-sentes.org se réserve le droit de modifier unilatéralement et à tout moment le contenu des
                présentes CGU.</p>
            </article>
            ...
            <article class="w-75">
                ...
                Adresse e-mail admin@les-sentes.org.
                L'hébergeur du site les-sentes.org est la société OVHcloud, dont le siège social est situé au 2, rue
            ...
            <article class="w-75">
                ...
                rendant à la page dédiée sur son espace personnel. Celle-ci sera effective immédiatement.
            ...
            <article class="w-75">
                ...
                <ul>
                    <li>par mail à l'adresse email admin@les-sentes.org</li>
                </ul>
            </article>
            ...
            <article class="w-75">
                ...
                <p>Le site les-sentes.org ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.</p>
