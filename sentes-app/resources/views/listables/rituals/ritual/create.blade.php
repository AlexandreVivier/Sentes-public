<x-layoutDoom>
    <main class="event-frame-content bg-light flex-row justify-center border-light">
        <section class="w-75 flex-col justify-center items-center">
            <h1 class="index-title special-elite-regular">Créer un rituel pour la liste {{$ritualList->name }} :</h1>
            <form action="{{ route('rituals.store', $ritualList->id) }}" method="POST" class="w-75 flex-col">
                @csrf
                ...
                <div class="form-input">
                    ...
                    <div class="w-100 show-button-container border-top-down-gradient">
                        ...
                        <button type="submit" class="green-button special-elite-regular">Créer le rituel</button>
                    </div>
            </form>
        </section>
    </main>
