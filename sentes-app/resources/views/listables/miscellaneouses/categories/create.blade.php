<x-layoutDoom>
    <main class="event-frame-content bg-light flex-row justify-center border-light">
        ...
        <h1 class="index-title special-elite-regular">Créer une Catégorie de listes</h1>
         <form action="{{ route('miscellaneous.categories.store')}}" method="POST" class="flex-col justify-center items-center" enctype="multipart/form-data">
            @csrf
            ...
            <div class="w-100 show-button-container border-top-down-gradient">
                ...
                <button type="submit" class="green-button special-elite-regular w-100">Créer la catégorie de listes diverses</button>
            </div>
        </form>
    </section>
</main>
